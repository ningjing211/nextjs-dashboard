  ...
  return (
        ...
        <section  className="section-words">
          <div className="block">
            ...
            <p>一就像跳迪斯可，沒人規定你要怎麼跳，但一定得搖起來。你不是每一次都選擇喝可樂，偶爾也得試試踩錯拍的尷尬，因為正是那些不合拍的瞬間，才蹦出最特別的節奏。創新不是什麼嚴肅的事，它更像是一種生活派對：帶點冒險、帶點試驗，還要帶著點幽默感。</p>
           </div>
        </section>
        ...
        <section  className="section-words">
          <div className="block">
            <p>生活這隻動物在我們心裡撒嬌的時候。我們本能地伸手撫摸它，卻又忍不住想問：你從哪來？為什麼選擇現在？它沒有回答，只是用一種靈動似鹿的眼眸，讓我們知道，城市的街道蜿蜒著樹的影子，像我們早晨喝的咖啡在杯緣留下星球運行的痕跡，生活總在我們不經意的細節裡開展；是無意間哼出的旋律，成為一天的背景音，整個世界在我們之間彼此交換氣息的時候，自然生長出的新枝新葉，腳下的土地正慢慢向你訴說它的語言，而天空的雲，也在用形狀和光影試探你的回應，先深深吸一口氣，然後允許世界通過你，成為什麼都可以的樣子。創新不是終點，而是那頭靜靜潛伏的動物，等待我們的靠近，等待一次毫無保留的擁抱。</p>
