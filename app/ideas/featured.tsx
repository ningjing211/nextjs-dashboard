                ...
                <div className="home-work_gallery w-dyn-list">
                    ...
                    >
                        ...
                        <div className="gallery_video hide-mobile-landscape w-embed">
                            ...
                            data-autoplay="true"
                            data-loop="true"
                            data-video-url="/left-top-motorcycle.mov"
                            data-wf-ignore="true"
                            >
                            <video
                                autoPlay
                    ...
                    >
                        ...
                        <div className="gallery_video hide-mobile-landscape w-embed">
                            ...
                            data-autoplay="true"
                            data-loop="true"
                            data-video-url="/right-top-horse.mov"
                            data-wf-ignore="true"
                            >
                            <video
                                autoPlay
                    ...
                    >                        
                        ...
                        <div className="gallery_video is-mobile w-embed">
                            ...
                            data-autoplay="true"
                            data-loop="true"
                            data-video-url="/right-down-man.mov"
                            data-wf-ignore="true"
                            >
                            <video
                                autoPlay
